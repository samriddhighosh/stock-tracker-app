    ...
    <main className='auth-layout'>
        <section className='auth-left-section scrollbar-hide-default'>
            <Link href="/" className="auth-logo">
                <Image src="/assets/icons/logo.svg" alt="Signlaist Logo" width={140} height={32} className='h-8 w-auto' />
            </Link>
        ...
        <section className='auth-right-section'>
            <div className='z-10 relative lg:mt-4 lg:mb-16'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex ietms-center gap-0.5'>
                        {[1,2,3,4,5].map((star)=>(
            ...
            <div className='flex-1 relative'>
                <Image src="/assets/images/dashboard.png" alt="Preview Dashboard" width={1440} height={1150} className='auth-dashboard-preview absolute top-0' />
